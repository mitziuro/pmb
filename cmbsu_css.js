var CMBSU_CSS = {
	...
	createNameLogo: function() {
		document.getElementById('iframe_name').innerHTML = '<iframe src="/LogoApp-ViewController-context-root/faces/logo.jspx" height="15px" width="230px;" scrolling="no" frameborder="0"></iframe>';
	},
